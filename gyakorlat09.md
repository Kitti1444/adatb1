...
WITH p.name AS nev, COUNT(m.title) AS db //uj nevek
WHERE db > 1 //mintha having lenne 
RETURN nev, db
```
...
7\. A Neo4J Sandbox Movie adatbázisából kérdezze le, hogy mely filmnek hány szereplője van!
